...
public class myPageServiceImpl implements myPageService {
	...
	public List<myPageDto> projectEndList(myPageDto input) throws Exception {
		...
		try {
			result = sqlSession.selectList("myPageMapper.projectEndList", input);
			if(result == null) {
				throw new NullPointerException("result=0");
			}
		} catch (NullPointerException e) {
	...
	public List<myPageDto> selectRecommandListForPro(myPageDto input) throws Exception {
		...
		try {
			result = sqlSession.selectList("myPageMapper.selectRecommandListForPro", input);
			if(result == null) {
				throw new NullPointerException("result=0");
			}
		} catch (NullPointerException e) {
	...
	public List<myPageDto> selectRecommandListForSell(myPageDto input) throws Exception {
		...
		try {
			result = sqlSession.selectList("myPageMapper.selectRecommandListForSell", input);
			if(result == null) {
				throw new NullPointerException("result=0");
			}
		} catch (NullPointerException e) {
