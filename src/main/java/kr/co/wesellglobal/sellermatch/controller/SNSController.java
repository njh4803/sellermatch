...
public class SNSController {
	...
	public String snsLoginCallback(@PathVariable String snsService,
		...
		/*
		 * MemberDto memberService.idCheck(input);
		 * 
		 * if (user == null) { model.addAttribute("result", "존재하지 않는 사용자입니다. 가입해 주세요.");
		 * 
		 * //미존재시 가입페이지로!!
		 * 
	...
	// 카카오 로그인창 호출
	@RequestMapping(value = "/oauth/getKakaoAuthUrl")
	public @ResponseBody String getKakaoAuthUrl(HttpServletRequest request) throws Exception {
		...
		String reqUrl = "https://kauth.kakao.com" + "/oauth/authorize?client_id=" + kakaoApiKey + "&redirect_uri="
	...
	// 구글 로그인창 호출
	@RequestMapping(value = "/oauth/getGoogleAuthUrl")
	public @ResponseBody String getGoogleAuthUrl(HttpServletRequest request) throws Exception {
		...
		String redirectURI = "http://127.0.0.1:8080/member/join"; //개발
		//String redirectURI = "http://sellermatch.co.kr/member/join"; // 운영
		String reqUrl = "https://accounts.google.com/o/oauth2/v2/auth?client_id=" + googleApiKey + "&redirect_uri="
				+ redirectURI + "&response_type=code" + "&scope=profile";

		return reqUrl;
	}

	// 네이버 로그인창 호출
	@RequestMapping(value = "/oauth/getNaverAuthUrl")
	public @ResponseBody String getNaverAuthUrl(HttpServletRequest request) throws Exception {
		...
		String redirectURI = "http://127.0.0.1:8080/member/join"; //개발
		//String redirectURI = "http://sellermatch.co.kr/member/join"; // 운영
		String reqUrl = "https://nid.naver.com/oauth2.0/authorize?client_id=" + naverApiKey + "&redirect_uri="
				+ redirectURI + "&response_type=code";
