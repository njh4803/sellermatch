...
<br>함께 오래갈 판매 사장님 연락기다리고 있습니다."><c:out value="${output.projDetail}" escapeXml="true" /></textarea>
		    							</c:if>
		    							<c:if test="${member.memSort == 2}">
		    								<textarea id="projDetail" name="projDetail" class="inputForm width-100" style="height: 150px;"
...
<br>함께 오래갈 공급처 사장님 연락기다리고 있습니다."><c:out value="${output.projDetail}" escapeXml="true" /></textarea>
		    							</c:if>
