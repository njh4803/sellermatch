...
가. 홈페이지 회원가입 및 관리
회원 가입의사 확인, 회원제 서비스 제공에 따른 본인 식별&middot;인증, 연령 확인, 회원자격 유지&middot;관리, 제한적 본인확인제 시행에 따른 본인확인, 서비스 부정이용 방지, 분쟁 조정을 위한 기록 보존 등을 목적으로 개인정보를 처리합니다.
나. 회원 불만 사항 처리
회원의 신원 확인, 민원 등 고충사항 확인, 사실조사를 위한 연락&middot;통지, 처리결과 통보 등을 목적으로 개인정보를 처리합니다.
다. 재화 또는 서비스 제공
서비스 제공, 청구서 발송, 콘텐츠 제공, 본인인증, 연령인증, 요금결제&middot;정산 등을 목적으로 개인정보를 처리합니다.
라. 서비스 개발
...
2. 개인정보 파일 현황
개인정보 파일명 : 셀러매치 개인정보
개인정보 항목 : 이메일, 휴대전화번호, 로그인ID, 비밀번호, 성별, 생년월일, 이름, 결제기록, 서비스 이용 기록, 방문 기록, 불량 이용 기록, 접속 로그, 디바이스 정보, 접속 브라우저 정보, 쿠키, 접속 IP 정보 등
...
3. 개인정보의 처리 및 보유 기간
① &lt;위셀글로벌 주식회사&gt;(&#39;셀러매치&#39;)는 법령에 따른 개인정보 보유&middot;이용기간 또는 정보주체로부터 개인정보를 수집 시에 동의 받은 개인정보 보유, 이용기간 내에서 개인정보를 처리, 보유합니다.
② 서비스 회원가입 및 관리, 서비스 제공, 회원 불만 사항 처리, 마케팅 및 광고에의 활용과 관련한 개인정보는 원칙적으로 회원 탈퇴(서비스 이용계약 해지) 시까지 위 이용목적을 위하여 보유∙이용됩니다.
③ 각각의 개인정보 처리 및 보유 기간은 다음과 같습니다.
&lt;마케팅 및 광고에의 활용&gt;
&lt;마케팅 및 광고에의 활용&gt;와 관련한 개인정보는 수집&middot;이용에 관한 동의일로부터&lt;3년&gt;까지 위 이용목적을 위하여 보유&middot;이용됩니다.
...
1) 관계 법령 위반에 따른 수사&middot;조사 등이 진행중인 경우에는 해당 수사&middot;조사 종료시까지
2) 서비스 이용에 따른 채권&middot;채무관계 잔존시에는 해당 채권, 채무관계 정산시까지
3) 재가입 후 무료 이용 재사용 등 서비스 부정이용 방지 목적을 위한 휴대전화번호 등 개인정보: 회원 탈퇴일로부터 1년
4) 전자상거래 등에서의 소비자 보호에 관한 법률에 따른 표시&middot;광고, 계약내용 및 이행 등 거래에 관한 기록 - 표시&middot;광고에 관한 기록: 6개월 - 소비자 불만 또는 분쟁처리, 신용정보의 수집∙처리 및 이용 등에 관한 기록: 3년 - 계약 또는 청약철회, 대금결제, 재화 등의 공급기록: 5년
5) 전자금융거래법에 따른 전자금융 거래에 관한 기록: 5년
6) 통신비밀보호법에 따른 거래에 관한 기록 - 가입자의 전기통신일시, 개시&middot;종료시간, 상대방 가입자번호, 사용도수, 발신기지국 위치추적자료에 관한 기록: 1년 - 컴퓨터 통신, 인터넷 로그기록자료, 접속지 추적자료 : 3개월

4. 개인정보의 제3자 제공
회사는 회원의 동의가 없는 경우 원칙적으로 회원의 개인정보를 제3자에게 제공하지 않습니다. 다만, 법령의 규정에 의해 국가기관이 법령에 정해진 절차와 방법에 따라 그 제공을 요청하는 경우 및 아래의 경우에는 예외로 합니다.
-회원이 사전에 제3자 제공에 동의한 경우

5. 정보주체와 법정대리인의 권리&middot;의무 및 그 행사방법
...
⑥ 위셀글로벌 주식회사는 정보주체 권리에 따른 열람의 요구, 정정&middot;삭제의 요구, 처리정지의 요구 시 열람 등 요구를 한 자가 본인이거나 정당한 대리인인지를 확인합니다.
...
7. 개인정보 자동 수집 장치의 설치&bull;운영 및 거부에 관한 사항
① 위셀글로벌 주식회사는 개별적인 맞춤서비스를 제공하기 위해 이용정보를 저장하고 수시로 불러오는 &lsquo;쿠키(cookie)&rsquo;를 사용합니다.
② 쿠키는 웹사이트를 운영하는데 이용되는 서버(http)가 이용자의 컴퓨터 브라우저에게 보내는 소량의 정보이며 이용자들의 PC 컴퓨터내의 하드디스크에 저장되기도 합니다.
가. 쿠키의 사용 목적
이용자가 방문한 각 서비스와 웹 사이트들에 대한 방문 및 이용형태, 인기 검색어, 보안접속 여부 등을 파악하여 이용자에게 최적화된 서비스를 제공하기 위해 사용됩니다.
나. 쿠키의 설치&bull;운영 및 거부
