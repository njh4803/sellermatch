...
<div class="partner_bnr">
    ...
    <div id="findCheckBox">
		...
		<div class="partner_wrap addbox2 selectProfile">
			<div style="display: inline-block;">
				<button id="spBtn" class="default-check text-center" value="공급자"><input type="checkbox" class="findCheck spFind" value="공급자">판매자 가입</button>
			</div>
			<div style="display: inline-block;">
			    <button id="ppBtn" class="default-check text-center" value="공급자"><input type="checkbox" class="findCheck ppFind" value="판매자">공급자 가입</button>
			</div>
		</div>
    </div>
    ...
    <div class="partner_wrap">
    	<div class="joinForm">
    	<div class="resultBox">
    		<div class="resultText">판매자가입을 선택하셨습니다. <span>다양한 고마진 공급자를 찾아 수익을 향상시키세요!</span></div>
    	</div>
    	<form action="${pageContext.request.contextPath}/member/join" id="join_form" name="join_form" method="post" enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-group row">
																<label for="memPw_confirm" class="col-sm-2 control-label" style="padding-right: 0;">비밀번호 확인
																	<span class="identify">*</span>
																</label>
																<div class="col-sm-10">
