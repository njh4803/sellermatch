															...
															<table class="table table-striped table-bordered" id="BoardDataListTable">
																<thead>
																	<tr class="replace-inputs">
																		...
																		<th class="text-center" style="vertical-align:middle;">탈퇴아이디</th>
																		<th class="text-center" style="vertical-align:middle;">탈퇴사유</th>
																		<th class="text-center" style="vertical-align:middle;">탈퇴상세사유</th>
																		<th class="text-center" style="vertical-align:middle;">탈퇴일자</th>
																	</tr>
																</thead>
															</table>
														</div>
	...
	BoardDataListTable = $("#BoardDataListTable").dataTable({
	        ...
	        'columns': [
	            ...
	            { 
	            	...
	            	'render' : function (withdrawReason) {
	            			var reason = '';
	            			if (withdrawReason == 0) {
	            				reason = '서비스가 유용하지 않아서';
	            			} else if (withdrawReason == 1) {
	            				reason = '이용하기 어려워서';
	            			} else if (withdrawReason == 2) {
	            				reason = '이용안내가 부족해서';
	            			} else if (withdrawReason == 3) {
	            				reason = '원하는 거래를 찾지 못해서';
	            			} else {
	            				reason = '기타';
	            			}
	            		return reason
...
/*  		.yadcf([
			{column_number : 2, filter_default_label: '전체'},
	]);  */
});
</script>
