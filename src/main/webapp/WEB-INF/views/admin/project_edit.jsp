                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="form-group">
												                    <div class="card-block">
												                        ...
												                        <div class="jFiler-items jFiler-row jFilerImg-box">
												                          <c:forEach var="image" items="${output.listImg}">
																						...
																						<div class="jFiler-item-inner">
																							<div class="jFiler-item-thumb">
																								...
																								<div class="jFiler-item-info">
																									<span class="jFiler-item-others">305 KB</span>
																								</div>
																								<div class="jFiler-item-thumb-image1">
																									<img id="jFilerImg" src="/upload/${image}" draggable="false">
																								</div>
																							</div>
                                                                ...
                                                                <div class="col-sm-10">
                                                                	<div class="form-group">
	                                                                    <input id="prodName" type="text" name="prodName" class="form-control" placeholder="이메일 입력"
	                                                                    	value="${output.prodName}">
	                                                                    <input type="hidden" id="pImage" value="${output.prodDetailImg}">
	                                                                    <!-- <span
                                                            ...
                                                            <div class="form-group row">
																...
																<div class="col-sm-10">
																	<input type="number" name="prodQty" class="form-control"
																		id="prodQty" min="0" pattern="#,###" value="${output.prodQty}"/>
																</div>
															</div>
                                                            <div class="form-group row">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <select id="prodIndusA" name="prodIndusA" class="form-control">
						                                                ...
						                                                <c:forEach var="indus" items="${output2}">
						                                                	<c:choose>
						                                                		<c:when test="${indus.indusId == output.prodIndusA}">
						                                                			<option value="${indus.indusId}" selected="selected">${indus.indusName}</option>
						                                                		</c:when>
						                                                		<c:otherwise>
						                                                		 	<option value="${indus.indusId}">${indus.indusName}</option>
						                                                		</c:otherwise>
						                                                	</c:choose>
						                                                </c:forEach>
						                                            </select>
...
$(function(){
	...
	$(".form-group").hover(function() {
		var imagetag = $(".jFiler-item-thumb-image img");
		//console.log(imagetag.attr("src"));
		
		if (imagetag.attr("src") != undefined) {
			$(".jFilerImg-box").remove();
		}
