...
<div class="partner_bnr">
    <div class="partner_wrap">
        	...
        	<div class="detailContentsTitle">
	        	...
	        	<div class="detailContentsTitleRegDate">
	        		<div class="infoBox">
	        			...
	        			<span class="regdateDate">
							<c:if test="${output.boardWriter != '관리자'}">
        ...
        <div class="detailContentsButtonBox">
        	<div class="detailContentsButton" OnClick="location.href ='${pageContext.request.contextPath}/board?boardType=4'" style="cursor:pointer;">
			    <a>목록으로</a>
			</div>
        </div>
   </div>
        	...
        	if (result.value) {
	       		$.ajax({
        			...
        			success: function(json){
        				window.location.href = ROOT_URL+"/board?boardType=4";
        			}
        		});
			} else {
				return;
